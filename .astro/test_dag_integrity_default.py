...
**USED BY DEV PARSE COMMAND DO NOT EDIT**"""
...
# The following code patches errors caused by missing OS
# Variables, Airflow Connections, and Airflow Variables
...
def os_getenv_monkeypatch(key: str, *args, **kwargs):
    ...
    if default:
        return default
    # otherwise return whatever default has been passed
...
def suppress_logging(namespace):
    """
    Suppress logging within a specific namespace to keep
    tests "clean" during build
    """
...
def get_import_errors():
    ...
    and include DAGs without errors.
    """
